...
def send_email(sender_email, receiver_email, subject, message):
    try:
        yag = yagmail.SMTP(sender_email, "drjo ltsf lqhk alox")
        yag.send(
            to=receiver_email,
            subject=subject,
            contents=message
...
# Twilio credentials
TWILIO_ACCOUNT_SID = 'AC0f4b21fbbe5aa27b56989a98a888425b'
TWILIO_AUTH_TOKEN = 'b37442c1efa71d2407ae994c2cffb3cb'
TWILIO_PHONE_NUMBER = '+18638773109'
...
account_sid = 'AC0f4b21fbbe5aa27b56989a98a888425b'
auth_token = 'b37442c1efa71d2407ae994c2cffb3cb'

# Your Twilio WhatsApp number (sandbox or purchased number)
from_whatsapp_number = 'whatsapp:+18638773109'
...
def email():
    if request.method == 'POST':
        data = request.form
        sender_email = "gamerunknown459@gmail.com"
